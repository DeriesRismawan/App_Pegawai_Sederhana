...
<html lang="en">
    <head>
        ...
        <title>Login - Aplikasi Pegawai | byDeriesRismawan </title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login - Aplikasi Pegawai<br><b>M.D.R</b></h3></div>
                                    <div class="card-body">
                ...
                <footer class="py-2 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Aplikasi-Pegawai|| byM.D.R 2021</div>
